...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/daftar_tugas.css')); ?>">
</head>
...
<td><?php echo e($t->mapel); ?></td>
<td><?php echo e($t->nama_kelas); ?></td>

<td>

<a href="<?php echo e(route('guru.tugas.detail',[
'judul'=>$t->judul,
'kelas'=>$t->kelas_id,
'mapel'=>$t->mapel
])); ?>">
...
<a href="<?php echo e(route('guru.nilai',[
'judul'=>$t->judul,
'kelas'=>$t->kelas_id,
'mapel'=>$t->mapel
])); ?>">
...
<form action="<?php echo e(route('tugas.delete',$t->id)); ?>" method="POST">
<?php echo csrf_field(); ?>
