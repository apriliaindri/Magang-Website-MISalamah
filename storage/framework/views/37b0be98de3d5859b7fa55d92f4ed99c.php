...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/edit_pengumuman.css')); ?>">
</head>
...
<?php if(count((array) $files)): ?>
                <div class="file-list">
                    ...
                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="file-item" id="file-<?php echo e($index); ?>">
                            ...
                            <div class="preview-card">
                                ...
                                <?php if(in_array($ext, ['jpg','jpeg','png','webp'])): ?>
                                    ...
                                    <img
                                        ...
                                        data-src="<?php echo e(asset('storage/' . $file)); ?>"
                                    >
                                ...
                                <?php elseif($ext === 'pdf'): ?>
                                    ...
                                    <a
                                        ...
                                        class="pdf-preview"
                                    >
                                        <img src="<?php echo e(asset('img/pdf-icon.png')); ?>" class="pdf-icon">
...
<script src="<?php echo e(asset('js/edit_pengumuman.js')); ?>"></script>
